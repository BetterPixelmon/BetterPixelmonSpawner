...
public class ReforgedHeldItemUtils {
    ...
    public static void tryApplyHeldItem (String fileName, EntityPixelmon wildPokemon, Pokemon playersPokemon) {
        ...
        for (int i = 0; i < percents.size(); i++) {
            ...
            if (RandomHelper.getRandomChance(percent)) {
                ...
                heldItem.setCount(1);
                wildPokemon.getPokemonData().setHeldItem(heldItem);
