...
public class PokemonCounter {
    ...
    public static Map<UUID, List<PixelmonEntity>> pokemonMap = new HashMap<>();
    ...
    public static void increment (PixelmonEntity pokemon, UUID uuid) {
    ...
    public static void addPokemon (PixelmonEntity pokemon, UUID uuid) {

        List<PixelmonEntity> pokeList = new ArrayList<>();
        ...
        if (pokemon.getTags().contains("PixelmonDefaultBoss") || pokemon.getTags().contains("BossPokemon:Tier-")) {
    ...
    public static void removePokemon (PixelmonEntity pokemon, UUID uuid) {
    ...
    public static void checkForDespawnPokemon (UUID uuid) {
        ...
        List<PixelmonEntity> pokemonList = pokemonMap.get(uuid);
