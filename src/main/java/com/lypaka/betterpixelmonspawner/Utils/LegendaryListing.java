...
public class LegendaryListing {
    ...
    public static String getLocation() {
        ...
        String w = LegendaryInfoGetters.getSpawnedPlayer().getServerWorld().getWorld().toString().replace("ServerLevel[", "").replace("]", "");
    ...
    public static void updateListingConfig (PixelmonEntity pokemon) {
        ...
        for (int i = 1; i <= amount; i++) {
            ...
            if (ConfigGetters.nextUpdatedSlot == 0) {
                ...
                BetterPixelmonSpawner.configManager.getConfigNode(8, "Spawns").setValue(spawnsMap);
                BetterPixelmonSpawner.configManager.getConfigNode(8, "Settings", "Next-Updated-Slot").setValue(2);
                ...
                BetterPixelmonSpawner.configManager.getConfigNode(8, "Settings", "Next-Updated-Slot").setValue(nextSlot);
                ...
                spawnsMap.put("Pokemon-" + ConfigGetters.nextUpdatedSlot, innerMap);
                BetterPixelmonSpawner.configManager.getConfigNode(8, "Spawns").setValue(spawnsMap);
                BetterPixelmonSpawner.configManager.getConfigNode(8, "Settings", "Next-Updated-Slot").setValue(1);
                ConfigGetters.nextUpdatedSlot = 1;
                break;
    ...
    public static void updatePokemonStatusCaptured (PixelmonEntity pokemon, ServerPlayerEntity player) throws ObjectMappingException {
        ...
        for (int i = 1; i <= amount; i++) {
            ...
            if (innerMap.get("UUID").equalsIgnoreCase(pokemon.getUniqueID().toString())) {
                ...
                innerMap.put("Status", "Captured by: " + player.getName().getString());
                BetterPixelmonSpawner.configManager.getConfigNode(8, "Spawns", "Pokemon-" + i).setValue(innerMap);
                break;
    ...
    public static void updatePokemonStatusKilled (PixelmonEntity pokemon, ServerPlayerEntity player) throws ObjectMappingException {
        ...
        for (int i = 1; i <= amount; i++) {
            ...
            if (innerMap.get("UUID").equalsIgnoreCase(pokemon.getUniqueID().toString())) {
                ...
                innerMap.put("Time", now.toString());
                innerMap.put("Status", "Killed by: " + player.getName().getString());
                BetterPixelmonSpawner.configManager.getConfigNode(8, "Spawns", "Pokemon-" + i).setValue(innerMap);
                break;
