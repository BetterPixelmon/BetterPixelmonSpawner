package com.lypaka.betterpixelmonspawner.Utils.Generations;
...
public class GenerationsLegendaryListing {

    public static String getLocation() {

        String w = GenerationsLegendaryInfoGetters.getPokemon().world.getSaveHandler().getWorldDirectory().getName();
        return w + "," + GenerationsLegendaryInfoGetters.getSpawnPos().getX() + "," +
                GenerationsLegendaryInfoGetters.getSpawnPos().getY() + "," + GenerationsLegendaryInfoGetters.getSpawnPos().getZ();
