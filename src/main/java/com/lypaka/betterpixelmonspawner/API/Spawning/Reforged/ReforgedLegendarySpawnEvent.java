 ...
 */
@Cancelable
public class ReforgedLegendarySpawnEvent extends Event {

    private EntityPixelmon pokemon;
    private EntityPlayerMP player;
    private LegendarySpawnInfo info;

    public ReforgedLegendarySpawnEvent (EntityPixelmon pokemon, EntityPlayerMP player, LegendarySpawnInfo info) {
