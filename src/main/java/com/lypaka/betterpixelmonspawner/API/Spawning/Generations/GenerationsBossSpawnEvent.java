...
@Cancelable
public class GenerationsBossSpawnEvent extends Event {

    private EntityPixelmon pokemon;
    private final EntityPlayerMP player;
    private PokemonSpawnInfo info;

    public GenerationsBossSpawnEvent (EntityPixelmon pokemon, EntityPlayerMP player, PokemonSpawnInfo info) {
