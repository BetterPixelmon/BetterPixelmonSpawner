...
import com.lypaka.betterpixelmonspawner.API.Spawning.Reforged.ReforgedLegendarySpawnEvent;
...
import com.lypaka.betterpixelmonspawner.Utils.Reforged.ReforgedLegendaryInfoGetters;
...
public class ReforgedLegendarySpawner {
            ...
            public void run() {
                ...
                FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                    ...
                    if (FlashFire.applies(finalFirstPartyPokemon)) {
                        ...
                        selectedSpawn = FlashFire.tryFlashFireOnReforgedLegendary(selectedSpawn, possibleSpawns, player);

                    } else if (Harvest.applies(finalFirstPartyPokemon)) {

                        selectedSpawn = Harvest.tryHarvestOnReforgedLegendary(selectedSpawn, possibleSpawns, player);

                    } else if (LightningRod.applies(finalFirstPartyPokemon) || Static.applies(finalFirstPartyPokemon)) {

                        selectedSpawn = LightningRod.tryLightningRodOnReforgedLegendary(selectedSpawn, possibleSpawns, player);

                    } else if (MagnetPull.applies(finalFirstPartyPokemon)) {

                        selectedSpawn = MagnetPull.tryMagnetPullOnReforgedLegendary(selectedSpawn, possibleSpawns, player);

                    } else if (StormDrain.applies(finalFirstPartyPokemon)) {

                        selectedSpawn = StormDrain.tryStormDrainOnReforgedLegendary(selectedSpawn, possibleSpawns, player);
                    ...
                    ReforgedLegendarySpawnEvent legendarySpawnEvent = new ReforgedLegendarySpawnEvent(pokemon, player, selectedSpawn);
                    ...
                    if (!legendarySpawnEvent.isCanceled()) {
                        ...
                        FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                            ...
                            LegendaryUtils.handleReforgedGlowing(legendarySpawnEvent.getPokemon());
                            LegendaryUtils.handleReforgedGracePeriod(legendarySpawnEvent.getPokemon(), legendarySpawnEvent.getPlayer());
                            ReforgedLegendaryInfoGetters.setLegendaryName(legendarySpawnEvent.getPokemon().getPokemonName());
                            ReforgedLegendaryInfoGetters.setPokemon(legendarySpawnEvent.getPokemon());
                            ReforgedLegendaryInfoGetters.setSpawnedPlayer(player);
                            ReforgedLegendaryInfoGetters.setSpawnPos(legendarySpawnEvent.getPokemon().getPosition());
                            ReforgedLegendaryInfoGetters.setTime(LocalDateTime.now());
                            ReforgedLegendaryListing.updateListingConfig(legendarySpawnEvent.getPokemon());
