package com.lypaka.betterpixelmonspawner.Spawners.Generations;

import com.lypaka.betterpixelmonspawner.API.HostileEvent;
import com.lypaka.betterpixelmonspawner.API.Spawning.*;
import com.lypaka.betterpixelmonspawner.API.Spawning.Generations.GenerationsBossSpawnEvent;
import com.lypaka.betterpixelmonspawner.API.Spawning.Generations.GenerationsHolidaySpawnEvent;
...
public class GenerationsPokemonSpawner {
                    ...
                    FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                        ...
                        if (BiomeList.biomesToPokemon.containsKey(biomeID)) {
                            ...
                            if (FlashFire.applies(finalFirstPartyPokemon)) {
                                ...
                                selectedSpawn = FlashFire.tryFlashFireOnGenerationsPokemon(selectedSpawn, possibleSpawns, player);

                            } else if (Harvest.applies(finalFirstPartyPokemon)) {

                                selectedSpawn = Harvest.tryHarvestOnGenerationsPokemon(selectedSpawn, possibleSpawns, player);

                            } else if (LightningRod.applies(finalFirstPartyPokemon) || Static.applies(finalFirstPartyPokemon)) {

                                selectedSpawn = LightningRod.tryLightningRodOnGenerationsPokemon(selectedSpawn, possibleSpawns, player);

                            } else if (MagnetPull.applies(finalFirstPartyPokemon)) {

                                selectedSpawn = MagnetPull.tryMagnetPullOnGenerationsPokemon(selectedSpawn, possibleSpawns, player);

                            } else if (StormDrain.applies(finalFirstPartyPokemon)) {

                                selectedSpawn = StormDrain.tryStormDrainOnGenerationsPokemon(selectedSpawn, possibleSpawns, player);
                            ...
                            for (int i = 0; i < groupSize; i++) {
                                ...
                                if (selectedSpawn.getHeldItemID() != null) {
                                    ...
                                    if (ConfigGetters.heldItemsEnabled) {
                                        ...
                                        GenerationsHeldItemUtils.tryApplyHeldItem(pokemonName, pokemon, finalFirstPartyPokemon);
                                ...
                                if (Intimidate.applies(finalFirstPartyPokemon) || KeenEye.applies(finalFirstPartyPokemon)) {
                                    ...
                                    pokemon = Intimidate.tryGenerationsIntimidate(pokemon, finalFirstPartyPokemon);
                                    if (pokemon == null) return;

                                }
                                pokemon = PokemonUtils.validateGenerationsPokemon(pokemon, level);
                                pokemon.setLocationAndAngles(x + RandomHelper.getRandomNumberBetween(2.75f, 6f), y, z + RandomHelper.getRandomNumberBetween(2.75f, 6f),0, 0);
                                pokemon.updateStats();
                                ...
                                if (!pokeModified) {
                                    ...
                                    if (HolidayHandler.activeHolidays != null && !HolidayHandler.activeHolidays.isEmpty()) {
                                        ...
                                        if (holidays.size() > 0) {
                                            ...
                                            GenerationsHolidaySpawnEvent holidaySpawnEvent = new GenerationsHolidaySpawnEvent(holiday, pokemon, player);
                                            ...
                                            if (!holidaySpawnEvent.isCanceled()) {
                                                ...
                                                FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                                                    ...
                                                    GenerationsPokemonCounter.increment(holidaySpawnEvent.getPokemon(), player.getUniqueID());
                                                    GenerationsPokemonCounter.addPokemon(holidaySpawnEvent.getPokemon(), player.getUniqueID());
                                            ...
                                            if (BossPokemonUtils.spawnBoss()) {
                                                ...
                                                if (RandomHelper.getRandomChance(ConfigGetters.bossSpawnChance)) {
                                                    ...
                                                    if (BossPokemonUtils.canSpawn(player)) {
                                                        ...
                                                        GenerationsBossSpawnEvent bossSpawnEvent = new GenerationsBossSpawnEvent(pokemon, player, selectedSpawn);
                                                        ...
                                                        if (!bossSpawnEvent.isCanceled()) {
                                                            ...
                                                            FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                                                                ...
                                                                GenerationsPokemonCounter.increment(bossSpawnEvent.getPokemon(), player.getUniqueID());
                                                                ...
                                                                GenerationsPokemonCounter.addPokemon(bossSpawnEvent.getPokemon(), player.getUniqueID());
                                            ...
                                            if (TotemPokemonUtils.canSpawn(player)) {
                                                ...
                                                if (!totemSpawnEvent.isCanceled()) {
                                                    ...
                                                    FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                                                        ...
                                                        GenerationsPokemonCounter.increment(totemSpawnEvent.getPokemon(), player.getUniqueID());
                                                        GenerationsPokemonCounter.addPokemon(totemSpawnEvent.getPokemon(), player.getUniqueID());
                                            ...
                                            if (AlphaPokemonUtils.canSpawn(player)) {
                                                ...
                                                if (!alphaSpawnEvent.isCanceled()) {
                                                    ...
                                                    FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                                                        ...
                                                        GenerationsPokemonCounter.increment(alphaSpawnEvent.getPokemon(), player.getUniqueID());
                                                        GenerationsPokemonCounter.addPokemon(alphaSpawnEvent.getPokemon(), player.getUniqueID());
                                ...
                                if (shiny || pokemon.isShiny()) {
                                    ...
                                    GenerationsShinySpawnEvent shinySpawnEvent = new GenerationsShinySpawnEvent(pokemon, player, selectedSpawn);
                                    ...
                                    if (!shinySpawnEvent.isCanceled()) {
                                        ...
                                        FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                                            ...
                                            GenerationsPokemonCounter.increment(shinySpawnEvent.getPokemon(), player.getUniqueID());
                                            GenerationsPokemonCounter.addPokemon(shinySpawnEvent.getPokemon(), player.getUniqueID());
                                    ...
                                    GenerationsPokemonSpawnEvent pokemonSpawnEvent = new GenerationsPokemonSpawnEvent(pokemon, player, selectedSpawn, groupSize);
                                    ...
                                    if (!pokemonSpawnEvent.isCanceled()) {
                                        ...
                                        FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                                            ...
                                            GenerationsPokemonCounter.increment(pokemonSpawnEvent.getPokemon(), player.getUniqueID());
                                            GenerationsPokemonCounter.addPokemon(pokemonSpawnEvent.getPokemon(), player.getUniqueID());
