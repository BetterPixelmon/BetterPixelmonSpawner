...
public class GenerationsFishSpawner {
    ...
    public void onFishCatch (FishingEvent.FishingReelEvent event) {
        ...
        if (event.isPokemon()) {
            ...
            if (Intimidate.applies(firstPartyPokemon) || KeenEye.applies(firstPartyPokemon)) {
                ...
                pokemon = Intimidate.tryGenerationsIntimidate(pokemon, firstPartyPokemon);
            ...
            if (selectedSpawn.getHeldItemID() != null) {
                ...
                if (ConfigGetters.heldItemsEnabled) {
                    ...
                    GenerationsHeldItemUtils.tryApplyHeldItem(pokemonName, pokemon, firstPartyPokemon);
