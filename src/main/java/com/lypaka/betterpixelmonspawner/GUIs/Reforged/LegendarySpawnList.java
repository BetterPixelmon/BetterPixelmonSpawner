...
public class LegendarySpawnList {
    ...
    public void build() {
        ...
        if (BiomeList.biomePokemonMap.containsKey(this.biome)) {
            ...
            ArrayList<WorldTime> currentTimes = WorldTime.getCurrent(this.player.world);
            String weather;
        ...
        for (int i = 0; i < pokemonList.size(); i++) {
            ...
            if (name.contains("-")) {
                ...
                if (name.equalsIgnoreCase("porygon-z")) {
                    ...
                    pokemon = PokemonSpec.from(name).create(player.world);
                    int pokemonForm = ReforgedFormIndexFromName.getFormNumberFromFormName(name, form);
            ...
            int dex = pokemon.getSpecies().getNationalPokedexInteger();
    ...
    private Button getNextButton (int pageToGoTo) {
        ...
        ItemStack icon = new ItemStack(Item.getByNameOrId("pixelmon:trade_holder_right"));
    ...
    private Button getPrevButton (int pageToGoTo) {
        ...
        ItemStack icon = new ItemStack(Item.getByNameOrId("pixelmon:trade_holder_left"));
    ...
    private Button getPokemonSprite (String name, LegendarySpawnInfo info) {
        ...
        if (ReforgedHeldItemUtils.heldItemMap.containsKey(name)) {

            Map<String, List<String>> possibleItems = null;
            for (Map.Entry<String, Map<String, List<String>>> entry : ReforgedHeldItemUtils.heldItemMap.entrySet()) {
