    ...
    public void open() {
        ...
        if (this.pokemonName.contains("-")) {
            ...
            if (this.pokemonName.equalsIgnoreCase("ho-oh")) {
                ...
                pokemon = PokemonSpec.from(this.pokemonName).create(this.player.world);
                int pokemonForm = GenerationsFormIndexFromName.getFormNumberFromFormName(this.pokemonName, form);
        ...
        sprite.setStackDisplayName(FancyText.getFormattedString("&a" + pokemon.getPokemonName()));
