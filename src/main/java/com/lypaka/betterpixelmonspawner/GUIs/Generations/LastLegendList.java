package com.lypaka.betterpixelmonspawner.GUIs.Generations;
    ...
    private static Button getButton (Map<String, String> data, EntityPlayerMP player) {
        ...
        if (id.contains("/")) {
            ...
            if (id.equalsIgnoreCase("pixelmon:pixelmon_sprite")) {
                ...
                if (other.contains("%pokemon")) {
                    ...
                    other = other.replace("%pokemon " + listing + "%", GenerationsLegendaryListing.getPokemonName(listing));
        ...
        if (data.containsKey("Name")) {
            ...
            if (stackName.contains("%pokemon")) {
                ...
                name = stackName.replace("%pokemon " + listing + "%", GenerationsLegendaryListing.getPokemonName(listing));
        ...
        if (data.containsKey("Status")) {
            ...
            if (status.contains("%status")) {
                ...
                int listing = Integer.parseInt(split[1].replace("%", ""));
                status = status.replace("%status " + listing + "%", GenerationsLegendaryListing.getStatus(listing));
        ...
        if (data.containsKey("Time")) {
            ...
            if (time.contains("%time")) {
                ...
                try {
                    ...
                    time = time.replace("%time " + listing + "%", GenerationsLegendaryListing.getTime(listing));
