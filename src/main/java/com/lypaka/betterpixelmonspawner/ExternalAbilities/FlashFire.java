...
public class FlashFire {
    ...
    public static LegendarySpawnInfo tryFlashFireOnLegendary (LegendarySpawnInfo originalSpawn, List<LegendarySpawnInfo> possibleSpawns) {
    ...
    public static PokemonSpawnInfo tryFlashFireOnPokemon (PokemonSpawnInfo originalSpawn, List<PokemonSpawnInfo> possibleSpawns) {
