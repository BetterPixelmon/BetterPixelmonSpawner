...
public class Harvest {
    ...
    public static LegendarySpawnInfo tryHarvestOnLegendary (LegendarySpawnInfo originalSpawn, List<LegendarySpawnInfo> possibleSpawns) {
    ...
    public static PokemonSpawnInfo tryHarvestOnPokemon (PokemonSpawnInfo originalSpawn, List<PokemonSpawnInfo> possibleSpawns) {
