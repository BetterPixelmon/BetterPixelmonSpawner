...
public class LightningRod {
    ...
    public static LegendarySpawnInfo tryLightningRodOnLegendary (LegendarySpawnInfo originalSpawn, List<LegendarySpawnInfo> possibleSpawns) {
    ...
    public static PokemonSpawnInfo tryLightningRodOnPokemon (PokemonSpawnInfo originalSpawn, List<PokemonSpawnInfo> possibleSpawns) {
