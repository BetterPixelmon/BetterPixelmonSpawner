...
public class GenerationsWhenCommand extends CommandBase {
    ...
    public void execute (MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if (GenerationsLegendarySpawner.nextSpawnAttempt != null) {

            LocalDateTime now = LocalDateTime.now();
            sender.sendMessage(FancyText.getFormattedText("&eThe next legendary spawn attempt will be in: " + makeTimeReadable(GenerationsLegendarySpawner.nextSpawnAttempt, now)));
