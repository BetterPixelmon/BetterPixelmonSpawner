...
public class ReforgedDebugCommand extends CommandBase {
        ...
        if (args.length < 2) {
            ...
            if (args.length == 3) {
                ...
                if (moduleArg.equalsIgnoreCase("npc")) {
                    ...
                    String mode;
                    String opposite;
                    if (ReforgedNPCSpawner.debugEnabled) {

                        ReforgedNPCSpawner.debugEnabled = false;
                        mode = "&cDisabled";
                        opposite = "enable";

                    } else {

                        ReforgedNPCSpawner.debugEnabled = true;
                        mode = "&aEnabled";
                        opposite = "disable";
