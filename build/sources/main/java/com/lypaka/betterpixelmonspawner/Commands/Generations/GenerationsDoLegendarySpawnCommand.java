...
import com.lypaka.betterpixelmonspawner.Spawners.Generations.GenerationsLegendarySpawner;
...
public class GenerationsDoLegendarySpawnCommand extends CommandBase {
                ...
                FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                    ...
                    if (!ConfigGetters.legendarySpawnMessage.equalsIgnoreCase("")) {
                        ...
                        BetterPixelmonSpawner.server.getPlayerList().sendMessage(FancyText.getFormattedText(ConfigGetters.legendarySpawnMessage
                                .replace("%biome%", GenerationsLegendarySpawner.getPrettyBiomeName(biomeID))
