...
public class ReforgedWhenCommand extends CommandBase {
    ...
    public void execute (MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if (ReforgedLegendarySpawner.nextSpawnAttempt != null) {

            LocalDateTime now = LocalDateTime.now();
            sender.sendMessage(FancyText.getFormattedText("&eThe next legendary spawn attempt will be in: " + makeTimeReadable(ReforgedLegendarySpawner.nextSpawnAttempt, now)));
