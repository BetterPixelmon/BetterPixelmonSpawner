...
public class LightningRod {
    ...
    public static LegendarySpawnInfo tryLightningRodOnGenerationsLegendary (LegendarySpawnInfo originalSpawn, List<LegendarySpawnInfo> possibleSpawns, EntityPlayerMP player) {
    ...
    public static PokemonSpawnInfo tryLightningRodOnGenerationsPokemon (PokemonSpawnInfo originalSpawn, List<PokemonSpawnInfo> possibleSpawns, EntityPlayerMP player) {
    ...
    public static LegendarySpawnInfo tryLightningRodOnReforgedLegendary (LegendarySpawnInfo originalSpawn, List<LegendarySpawnInfo> possibleSpawns, EntityPlayerMP player) {
        ...
        for (LegendarySpawnInfo info : possibleSpawns) {
            ...
            if (pokemon.getBaseStats().getType1() == com.pixelmonmod.pixelmon.enums.EnumType.Electric || pokemon.getBaseStats().getType2() == com.pixelmonmod.pixelmon.enums.EnumType.Electric) {
    ...
    public static PokemonSpawnInfo tryLightningRodOnReforgedPokemon (PokemonSpawnInfo originalSpawn, List<PokemonSpawnInfo> possibleSpawns, EntityPlayerMP player) {
