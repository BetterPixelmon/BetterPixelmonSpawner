...
public class Harvest {
    ...
    public static LegendarySpawnInfo tryHarvestOnGenerationsLegendary (LegendarySpawnInfo originalSpawn, List<LegendarySpawnInfo> possibleSpawns, EntityPlayerMP player) {

        if (!RandomHelper.getRandomChance(50)) return originalSpawn;
        List<LegendarySpawnInfo> grassPokemon = new ArrayList<>();
        for (LegendarySpawnInfo info : possibleSpawns) {
            ...
            if (pokemon.baseStats.type1 == EnumType.Grass || pokemon.baseStats.type2 == EnumType.Grass) {

                grassPokemon.add(info);
        ...
        if (grassPokemon.size() == 0) {
            ...
            List<Double> spawnChances = new ArrayList<>(grassPokemon.size());
            int spawnIndex = 0;
            double spawnChanceModifier = 1.0;
            for (LegendarySpawnInfo info : grassPokemon) {
            ...
            int spawnAmount = grassPokemon.size();
    ...
    public static PokemonSpawnInfo tryHarvestOnGenerationsPokemon (PokemonSpawnInfo originalSpawn, List<PokemonSpawnInfo> possibleSpawns, EntityPlayerMP player) {

        if (!RandomHelper.getRandomChance(50)) return originalSpawn;
        List<PokemonSpawnInfo> grassPokemon = new ArrayList<>();
        ...
        if (grassPokemon.size() == 0) {
            ...
            int spawnIndex = 0;
            double spawnChanceModifier = 1.0;
            for (PokemonSpawnInfo info : grassPokemon) {
    ...
    public static LegendarySpawnInfo tryHarvestOnReforgedLegendary (LegendarySpawnInfo originalSpawn, List<LegendarySpawnInfo> possibleSpawns, EntityPlayerMP player) {
        ...
        for (LegendarySpawnInfo info : possibleSpawns) {
            ...
            if (pokemon.getBaseStats().getType1() == com.pixelmonmod.pixelmon.enums.EnumType.Grass || pokemon.getBaseStats().getType2() == com.pixelmonmod.pixelmon.enums.EnumType.Grass) {
    ...
    public static PokemonSpawnInfo tryHarvestOnReforgedPokemon (PokemonSpawnInfo originalSpawn, List<PokemonSpawnInfo> possibleSpawns, EntityPlayerMP player) {
