 ...
 */
@Cancelable
public class GenerationsPokemonSpawnEvent extends Event {
    ...
    public GenerationsPokemonSpawnEvent (EntityPixelmon pokemon, EntityPlayerMP player, PokemonSpawnInfo info, int groupSize) {
