package com.lypaka.betterpixelmonspawner.Utils.Reforged;
...
public class ReforgedLegendaryListing {

    public static String getLocation() {

        String w = ReforgedLegendaryInfoGetters.getPokemon().world.getSaveHandler().getWorldDirectory().getName();
        return w + "," + ReforgedLegendaryInfoGetters.getSpawnPos().getX() + "," +
                ReforgedLegendaryInfoGetters.getSpawnPos().getY() + "," + ReforgedLegendaryInfoGetters.getSpawnPos().getZ();
