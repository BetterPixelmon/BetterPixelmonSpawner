...
import com.lypaka.betterpixelmonspawner.API.Spawning.Generations.GenerationsNPCSpawnEvent;
...
public class GenerationsNPCSpawner {
            ...
            public void run() {
                ...
                FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                    ...
                    for (Map.Entry<UUID, EntityPlayerMP> playerEntry : JoinListener.playerMap.entrySet()) {
                        ...
                        EntityLivingBase entity = GenerationsEntityUtils.getEntityFromID(biomeID, selectedID, player.world);
                        if (entity == null) {
                        ...
                        GenerationsNPCSpawnEvent npcSpawnEvent = new GenerationsNPCSpawnEvent((EntityNPC) entity, player);
                        ...
                        if (!npcSpawnEvent.isCanceled()) {
                            ...
                            FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                                ...
                                GenerationsEntityUtils.handleDespawning(npcSpawnEvent.getNPC());
