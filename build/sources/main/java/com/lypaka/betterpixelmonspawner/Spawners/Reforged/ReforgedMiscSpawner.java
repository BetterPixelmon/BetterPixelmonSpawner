...
import com.lypaka.betterpixelmonspawner.API.Spawning.Reforged.ReforgedMiscSpawnEvent;
...
public class ReforgedMiscSpawner {
                ...
                FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                    ...
                    for (Map.Entry<UUID, EntityPlayerMP> playerEntry : JoinListener.playerMap.entrySet()) {
                        ...
                        if (selectedID.equalsIgnoreCase("pixelmon:ultra_wormhole")) {
                            ...
                            EntityWormhole entity = new EntityWormhole(player.world);
                            ...
                            ReforgedMiscSpawnEvent miscSpawnEvent = new ReforgedMiscSpawnEvent(entity, player, selectedID);
                            ...
                            if (!miscSpawnEvent.isCanceled()) {
                                ...
                                FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                                    ...
                                    ReforgedEntityUtils.handleDespawning(miscSpawnEvent.getEntity());
                            ...
                            EntityLivingBase entity = ReforgedEntityUtils.getEntityFromID(null, selectedID, player.world);
                            if (entity == null) {
