...
import com.lypaka.betterpixelmonspawner.API.Spawning.Generations.GenerationsLegendarySpawnEvent;
...
import com.lypaka.betterpixelmonspawner.Utils.Generations.GenerationsLegendaryInfoGetters;
...
public class GenerationsLegendarySpawner {
            ...
            public void run() {
                ...
                FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                    ...
                    if (FlashFire.applies(finalFirstPartyPokemon)) {
                        ...
                        selectedSpawn = FlashFire.tryFlashFireOnGenerationsLegendary(selectedSpawn, possibleSpawns, player);

                    } else if (Harvest.applies(finalFirstPartyPokemon)) {

                        selectedSpawn = Harvest.tryHarvestOnGenerationsLegendary(selectedSpawn, possibleSpawns, player);

                    } else if (LightningRod.applies(finalFirstPartyPokemon) || Static.applies(finalFirstPartyPokemon)) {

                        selectedSpawn = LightningRod.tryLightningRodOnGenerationsLegendary(selectedSpawn, possibleSpawns, player);

                    } else if (MagnetPull.applies(finalFirstPartyPokemon)) {

                        selectedSpawn = MagnetPull.tryMagnetPullOnGenerationsLegendary(selectedSpawn, possibleSpawns, player);

                    } else if (StormDrain.applies(finalFirstPartyPokemon)) {

                        selectedSpawn = StormDrain.tryStormDrainOnGenerationsLegendary(selectedSpawn, possibleSpawns, player);
                    ...
                    GenerationsLegendarySpawnEvent legendarySpawnEvent = new GenerationsLegendarySpawnEvent(pokemon, player, selectedSpawn);
                    ...
                    if (!legendarySpawnEvent.isCanceled()) {
                        ...
                        FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                            ...
                            LegendaryUtils.handleGenerationsGlowing(legendarySpawnEvent.getPokemon());
                            LegendaryUtils.handleGenerationsGracePeriod(legendarySpawnEvent.getPokemon(), legendarySpawnEvent.getPlayer());
                            GenerationsLegendaryInfoGetters.setLegendaryName(legendarySpawnEvent.getPokemon().getPokemonName());
                            GenerationsLegendaryInfoGetters.setPokemon(legendarySpawnEvent.getPokemon());
                            GenerationsLegendaryInfoGetters.setSpawnedPlayer(player);
                            GenerationsLegendaryInfoGetters.setSpawnPos(legendarySpawnEvent.getPokemon().getPosition());
                            GenerationsLegendaryInfoGetters.setTime(LocalDateTime.now());
                            GenerationsLegendaryListing.updateListingConfig(legendarySpawnEvent.getPokemon());
                            ...
                            if (!ConfigGetters.legendarySpawnMessage.equalsIgnoreCase("")) {
                                ...
                                BetterPixelmonSpawner.server.getPlayerList().sendMessage(FancyText.getFormattedText(ConfigGetters.legendarySpawnMessage
