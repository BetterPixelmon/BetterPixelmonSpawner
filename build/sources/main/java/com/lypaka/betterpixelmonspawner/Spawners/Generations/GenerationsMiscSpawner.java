...
import com.lypaka.betterpixelmonspawner.API.Spawning.Generations.GenerationsMiscSpawnEvent;
import com.lypaka.betterpixelmonspawner.DeadZones.DeadZone;
import com.lypaka.betterpixelmonspawner.BetterPixelmonSpawner;
import com.lypaka.betterpixelmonspawner.Config.ConfigGetters;
import com.lypaka.lypakautils.FancyText;
import com.lypaka.betterpixelmonspawner.Utils.PokemonUtils.GenerationsEntityUtils;
...
public class GenerationsMiscSpawner {
            ...
            public void run() {
                ...
                FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                    ...
                    for (Map.Entry<UUID, EntityPlayerMP> playerEntry : JoinListener.playerMap.entrySet()) {
                        ...
                        EntityLivingBase entity = GenerationsEntityUtils.getEntityFromID(null, selectedID, player.world);
                        if (entity == null) {
                        ...
                        GenerationsMiscSpawnEvent miscSpawnEvent = new GenerationsMiscSpawnEvent(entity, player, selectedID);
                            ...
                            FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                                ...
                                if (ConfigGetters.miscBroadcastMap.containsKey(miscSpawnEvent.getSelectedEntityID())) {
                                    ...
                                    if (!message.equalsIgnoreCase("")) {
                                        ...
                                        FMLCommonHandler.instance().getMinecraftServerInstance().getPlayerList().sendMessage(FancyText.getFormattedText(message
                                                .replace("%biome%", biome)
                                ...
                                GenerationsEntityUtils.handleDespawning(miscSpawnEvent.getEntity());
